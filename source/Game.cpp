...
Game::Game() {
    ...
    // SỬA LỖI: Thêm "../" để đi lùi từ thư mục "build"
    ...
    // SỬA LỖI: Thêm "../"
    if (!menuBackgroundTex.loadFromFile("../assets/sprites/Start_Background.png")) {
    ...
    // SỬA LỖI: Thêm "../"
    allies = {
        Monster("Akama", 30, 10, "../assets/sprites/Akama.png"),      
        Monster("Beloid_A", 25, 7, "../assets/sprites/Beloid_A.png"),  
        Monster("Boglin",   35, 8, "../assets/sprites/Boglin.png")     
    };
